...
(function ($) {
    ...
    $.fn.treeview = function (settings) {
        var dfop =
            {
                 ...
                 */
                cbiconpath: "/Content/Scripts/tree/Images/icons/",
        ...
        function buildnode(nd, ht, deep, path, isend) {
            ...
            if (nd.img != undefined) {
                _img = "<img style='vertical-align: middle;width:16px;height:16px;padding-bottom:2px;padding-right:2px;' src='" + nd.img + "'/>";
            }
            ht.push(_img);
            //checkbox
