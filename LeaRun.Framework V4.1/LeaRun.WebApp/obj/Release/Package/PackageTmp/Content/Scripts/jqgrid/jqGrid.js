    ...
    $.fn.jqGrid = function (pin) {
        ...
        return this.each(function () {
                ...
                if (pgboxes) {
                    ...
                    if (ts.p.viewrecords) {
                        if (ts.p.reccount === 0) {
                            ...
                            $(".ui-paging-info", pgboxes).html($.jgrid.format(ts.p.recordtext, from.replace(' ', ''), to.replace(' ', ''), tot.replace(' ', ''), _totaltime));
                        }
                    }
            ...
            setPager = function (pgid, tp) {
                ...
                $("#" + $.jgrid.jqID(pgid))
                .append("<div id='" + pgcnt + "' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='" + cent + "' align='center' style='white-space:pre;'></td><td id='" + rgt + "' align='right'></td><td id='" + lft + "' align='left'></td></tr></tbody></table></div>")
                ...
                if (twd > 0) {
                    ...
                    $("td#" + pgid + "_" + ts.p.pagerpos, "#" + pgcnt).width(twd - 27);
                }
                ts.p._nvtd = [];
